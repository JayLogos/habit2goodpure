...
public class MyCircleMenuView extends FrameLayout {
    ...
    public static class EventListener {
         ...
         * @param view current MyCircleMenuView instance.
         */
         ...
         */
        public void onButtonClickAnimationStart(@NonNull MyCircleMenuView view, int buttonIndex) {}
         ...
         * @param buttonIndex - clicked button zero-based index.
         */
        public void onButtonClickAnimationEnd(@NonNull MyCircleMenuView view, int buttonIndex) {}
         ...
         */
        public boolean onButtonLongClick(@NonNull MyCircleMenuView view, int buttonIndex) { return false; }
         ...
         * @param buttonIndex - clicked button zero-based index.
         */
        public void onButtonLongClickAnimationStart(@NonNull MyCircleMenuView view, int buttonIndex) {}
         ...
         * @param buttonIndex - clicked button zero-based index.
         */
        public void onButtonLongClickAnimationEnd(@NonNull MyCircleMenuView view, int buttonIndex) {}
    }
        ...
        public void onClick(final View view) {
            ...
            click.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationStart(Animator animation) {
                    if (mListener != null) {
                        mListener.onButtonClickAnimationStart(MyCircleMenuView.this, mButtons.indexOf(view));
                    }
                }
                @Override
                public void onAnimationEnd(Animator animation) {
                    mClosedState = true;
                    if (mListener != null) {
                        mListener.onButtonClickAnimationEnd(MyCircleMenuView.this, mButtons.indexOf(view));
                    }
                }
            });
            click.start();
    ...
    private class OnButtonLongClickListener implements View.OnLongClickListener {
        ...
        public boolean onLongClick(final View view) {
            ...
            final boolean result =  mListener.onButtonLongClick(MyCircleMenuView.this, mButtons.indexOf(view));
            if (result && !mIsAnimating) {
                ...
                click.addListener(new AnimatorListenerAdapter() {
                    @Override
                    public void onAnimationStart(Animator animation) {
                        mListener.onButtonLongClickAnimationStart(MyCircleMenuView.this, mButtons.indexOf(view));
                    }
                    @Override
                    public void onAnimationEnd(Animator animation) {
                        mClosedState = true;
                        mListener.onButtonLongClickAnimationEnd(MyCircleMenuView.this, mButtons.indexOf(view));
                    }
                });
                click.start();
            }
    ...
    public MyCircleMenuView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);

    }

    public MyCircleMenuView(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        try {
            ...
            mIconMenu = a.getResourceId(R.styleable.CircleMenuView_icon_menu, R.drawable.ic_add_black_24dp);
    ...
    /**
     * Constructor for creation MyCircleMenuView in code, not in xml-layout.
     ...
     */
    public MyCircleMenuView(@NonNull Context context, @NonNull List<Integer> icons, @NonNull List<Integer> colors) {
        super(context);

        final float density = context.getResources().getDisplayMetrics().density;
        final float defaultDistance = DEFAULT_DISTANCE * density;

        mIconMenu = R.drawable.ic_add_black_24dp;
    ...
    private void initMenu(int menuButtonColor) {
        final AnimatorListenerAdapter animListener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                if (mListener != null) {
                    if (mClosedState) {
                        mListener.onMenuOpenAnimationStart(MyCircleMenuView.this);
                    } else {
                        mListener.onMenuCloseAnimationStart(MyCircleMenuView.this);
                    }
                }
            }
            @Override
            public void onAnimationEnd(Animator animation) {
                if (mListener != null) {
                    if (mClosedState) {
                        mListener.onMenuOpenAnimationEnd(MyCircleMenuView.this);
                    } else {
                        mListener.onMenuCloseAnimationEnd(MyCircleMenuView.this);
                    }
                }
    ...
    private Animator getOpenMenuAnimation() {
        ...
        /*
        mMenuButton.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                final float centerX = mMenuButton.getX();
                final float centerY = mMenuButton.getY();

                mMenuButton.getViewTreeObserver().removeOnGlobalLayoutListener(this);
            }
        }); */
        final float centerX = mMenuButton.getX();
        final float centerY = mMenuButton.getY();
    ...
    /**
     * See {@link MyCircleMenuView.EventListener }
    ...
    private void openOrClose(boolean open, boolean animate) {
        ...
        if (animate) {
            /*
            *   mMenuButton 의 위치 값이 (0.0)로 리턴되어 sub FAB 의 위치가 잘못 잡히는 현상 발생
            *   아래 코드로 view(mMenuButton)의 위치가 잡힐 때까지 기다렸다가 로직을 진행하게 함.
             */
            if (mMenuButton.getX() != 0) {
            ...
            //Original code: mMenuButton.performClick();
        } else {
            mClosedState = !open;
